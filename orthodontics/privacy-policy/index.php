<?php
$page_title       = 'Privacy Policy | Sonrisa Dental Specialists';
$page_description = 'Learn how Sonrisa Dental Specialists collects, uses, and protects your personal information.';
...
<section class="section legal-section">
  <div class="container legal-container">
    ...
    <div class="legal-body">
      ...
      <p class="legal-intro">At Sonrisa Dental Specialists, your privacy is important to us. This Privacy Policy explains what information we collect when you visit our website or contact our practice, how we use it, and the choices you have. Please read it carefully.</p>

      <h2 id="information-we-collect">1. Information We Collect</h2>
      <h3>Information You Provide Directly</h3>
      <p>When you fill out a contact form, request a consultation, or otherwise communicate with us, we may collect:</p>
      <ul>
        <li>Your name, phone number, and email address</li>
        <li>The reason for your inquiry or appointment request</li>
        <li>Any other information you voluntarily provide in messages to us</li>
      </ul>
      ...
      <ul>
        ...
        <li>Analyze website traffic and usage patterns (in aggregated, anonymous form)</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Legal Requirements:</strong> When disclosure is required by law, court order, or government authority.</li>
      ...
      <ul>
        ...
        <li><strong>Analytics Cookies:</strong> We use Google Analytics to understand how visitors use our site. This data is aggregated and does not identify you personally.</li>
        <li><strong>Marketing Cookies:</strong> Used to deliver relevant advertising through platforms such as Google Ads.</li>
      </ul>
