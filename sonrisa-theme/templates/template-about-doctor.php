<?php
/*
Template Name: About - Meet the Doctor
*/
global $sonrisa_page;
$sonrisa_page = [
    'title'       => 'Meet the Doctor | Sonrisa Dental Specialists',
    'description' => 'Learn about the orthodontic specialist at Sonrisa Dental Specialists — 30+ years of experience, 20,000+ smiles transformed, and a deep commitment to exceptional patient care in Orlando, FL.',
    'class'       => 'page-doctor',
];
get_header();
?>
