...
global $sonrisa_page;
$sonrisa_page = [
    'title'        => 'Dentist in Orlando, FL | Sonrisa Dental Specialists',
    'description'  => 'Sonrisa Dental Specialists — comprehensive dental care in Orlando, FL. Serving Lake Nona and Oviedo with general dentistry, dental implants, and orthodontics. Call (407) 359-1960.',
    'class'        => 'page-home',
    'hide_top_bar' => true,
];
get_header();
