...
<footer class="site-footer">
  <div class="footer-inner container">
    ...
    <div class="footer-brand">
      <a href="/" aria-label="Sonrisa Dental Specialists — Home">
    ...
    <div class="footer-col">
      <h3 class="footer-heading">Dental Implants</h3>
      <ul class="footer-links">
        ...
        <li><a href="/dental-implants/services/full-mouth-dental-implants/">Full Mouth Implants</a></li>
    ...
    <div class="footer-col">
      <h3 class="footer-heading">Orthodontics</h3>
      <ul class="footer-links">
