<?php
$page_title       = 'Full Arch Dental Implants | Sonrisa Dental Specialists';
$page_description = 'Restore an entire upper or lower arch of teeth with full arch dental implants at Sonrisa Dental Specialists. Fixed, permanent, and life-changing. Miami, FL.';
$page_class       = 'page-full-arch';
...
<section class="hero hero-sm">
  ...
  <div class="hero-inner">
    <div class="hero-content">
      ...
      <h1>
        Restore Your Entire Arch.<br>
        <span class="hero-accent">Permanently.</span>
      </h1>
  ...
  <div class="container">
    <div class="two-col">
      ...
      <div class="two-col-text">
        ...
        <p>We provide comprehensive care from the initial consultation to the final prosthetic, with flexible financing options that make this life-changing treatment accessible. Thousands of patients across Miami have walked out of Sonrisa with a complete, permanent smile.</p>
        <ul class="experts-checklist">
