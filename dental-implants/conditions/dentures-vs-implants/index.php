<?php
$page_title       = 'Dentures vs. Dental Implants — Which Is Right for You? | Sonrisa';
$page_description = 'Comparing dentures and dental implants? See the honest differences in comfort, cost, bone health, and longevity — and find out why most patients choose implants.';
...
<section class="hero hero-sm">
  ...
  <div class="hero-inner">
    <div class="hero-content">
      ...
      <h1>
        Dentures vs.<br>
        <span class="hero-accent">Dental Implants.</span>
      </h1>
