<?php
$page_title       = 'Missing Teeth — When to Act & What to Expect | Sonrisa Dental Specialists';
$page_description = 'Missing teeth affect more than your appearance. Learn what happens when gaps go untreated and how dental implants permanently restore your smile and bone health.';
...
<section class="hero hero-sm">
  ...
  <div class="hero-inner">
    <div class="hero-content">
      ...
      <h1>
        Living With<br>
        <span class="hero-accent">Missing Teeth.</span>
      </h1>
