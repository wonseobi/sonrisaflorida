<?php
$page_title       = 'Replace Missing Teeth with Dental Implants | Sonrisa Dental Specialists';
$page_description = 'Discover the best ways to replace missing teeth with dental implants. Sonrisa offers single implants, full-arch restoration, and same-day solutions for any case.';
$page_class       = 'page-condition';
...
<section class="hero hero-sm">
  ...
  <div class="hero-inner">
    <div class="hero-content">
      ...
      <h1>
        Ready to Replace<br>
        <span class="hero-accent">Your Missing Teeth?</span>
      </h1>
