<?php
$page_title       = 'All-on-6 Dental Implants — Superior Stability Full Arch | Sonrisa';
$page_description = 'All-on-6 dental implants use six implants per arch for exceptional stability and load distribution. Ideal for patients wanting the strongest possible full-arch result.';
