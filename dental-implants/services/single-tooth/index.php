<?php
$page_title       = 'Single Tooth Dental Implant — Replace One Missing Tooth | Sonrisa';
$page_description = 'A single tooth dental implant replaces one missing tooth with a permanent, natural-looking crown — without altering adjacent teeth. The cleanest solution available.';
