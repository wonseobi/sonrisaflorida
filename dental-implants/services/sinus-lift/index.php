<?php
$page_title       = 'Sinus Lift Surgery for Upper Jaw Implants | Sonrisa Dental Specialists';
$page_description = 'A sinus lift adds bone to the upper jaw when sinus cavities sit too close to the implant site. It\'s a safe, proven procedure that opens the door to upper arch implants.';
